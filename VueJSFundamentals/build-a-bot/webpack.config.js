{
  mode: 'production',
  context: 'C:\\DevelopmentTutorials\\build-a-bot',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    dgram: 'empty',
  ...
  output: {
    path: 'C:\\DevelopmentTutorials\\build-a-bot\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\DevelopmentTutorials\\build-a-bot\\src',
    ...
    modules: [
      'node_modules',
      'C:\\DevelopmentTutorials\\build-a-bot\\node_modules',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'C:\\DevelopmentTutorials\\build-a-bot\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '11cff48e'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: 'C:\\DevelopmentTutorials\\build-a-bot\\node_modules\\mini-css-extract-plugin\\dist\\loader.js',
                options: {
                  publicPath: '../'
                }
              },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '788a936d',
              emitWarning: true,
              emitError: false,
              eslintPath: 'C:\\DevelopmentTutorials\\build-a-bot\\node_modules\\eslint\\lib\\api.js',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\DevelopmentTutorials\\build-a-bot\\public\\index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'C:\\DevelopmentTutorials\\build-a-bot\\public',
          to: 'C:\\DevelopmentTutorials\\build-a-bot\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
